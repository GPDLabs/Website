...
function PageComponent() {
  return (
    <div id="terms" className="w-full mx-auto max-w-screen-xl px-6 py-10 md:py-[120px] font-Roboto">
      <h1 className="text-[32px] text-left uppercase lg:text-[80px] leading-tight mb-7">TERMS OF SERVICE</h1>
      ...
      <article className="text-base leading-relaxed text-justify">
        ...
        <p className="mb-[1.25rem]">
          This Terms of Service Agreement (the “Agreement”) is made and entered into by and between you and GPD Labs
          Inc., a corporation (the “Company”, “us”, “we”, or “our”). This Agreement sets forth the terms and conditions
          that govern your use of and access to the products, materials, and services provided through or on the io.net
          website (the “Website”), including any Company-provided computer or mobile software or application
        ...
        <ul className="list-disc pl-5">
          ...
          <li>
            Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to GPD Labs,
            Inc., 223 Bedford Ave PMB 530 Brooklyn, NY 11211.
          </li>
          <li>
          ...
          <li>Website refers to gpdlabs.io, accessible from http://gpdlabs.io/</li>
          <li>
        ...
        <p>Third-party web sites include:</p>
        <ul className=" list-disc pl-5">
          <li className="underline">YouTube Terms of Service</li>
        </ul>
        <p>Termination</p>
        <p>
        ...
        <ul className="list-disc pl-5">
          <li>
            By email: <a href="mailto:contact@gpdlabs.io">contact@gpdlabs.io</a>
          </li>
        </ul>
      </article>
    </div>
